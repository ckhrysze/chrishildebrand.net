defmodule CkhryszeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(CkhryszeWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(CkhryszeWeb.Gettext, "errors", msg, opts)
    # end
