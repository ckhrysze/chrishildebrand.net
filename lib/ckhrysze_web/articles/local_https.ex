defmodule CkhryszeWeb.Articles.LocalHttps do
  ...
  def render(assigns) do
    ~H"""
    <p>
      Several years ago, when I was still doing a lot of web development in Ruby, I used Pow.
    ...
    <p>
      I'm not the only one to make heavy use of .dev, so was able to find several
    ...
    <p>
      ...
      had anything to solve the issue, I came across
      <.a href="https://letsencrypt.org/docs/certificates-for-localhost/">this article</.a>. From there, I grabbed and used
